...
const MembriCards = [
  {
    ...
    name: "Șerban Andrei (aka Shobi)",
    role: "-> Team Leader",
    text: "I am 18 years old, a mechanic and social media manager, but I manage to help all my teammates from all departments. I have been part of FTC for 2 years. This season, my goal is to have fun and make more friends.",
    insta: "https://www.instagram.com/serban_andrei__/",
    gram: "@serban_andrei_",
  },
  {
    ...
    name: "Deaconu Mihai (aka Angelo)",
    role: "-> 3D Designer & Coach",
    text: "Hello! My name is Deaconu Anghel Mihai, and I am a 12th-grade student at 'Alexandru Odobescu' National College. I am part of the 3D Design and Mechanics departments.",
    insta: "https://www.instagram.com/da.alex7/",
    gram: "@da.alex7",
  },
  {
    ...
    name: "Antonia Gheorghiță (aka Antoina)",
    role: "-> Design",
    text: "I am Antonia Gheorghiță, also known as Antoina, and I am part of the StarLight Robotics team. I am in 12th grade and joined the team out of a desire to gain experience in a new and fascinating field for me—robotics.",
    insta: "https://www.instagram.com/antoniasiatwt/",
    gram: "@antoniasiatwt",
  },
  {
    ...
    name: "Bucur Andrei",
    role: "-> Programmer & Driver",
    text: "My name is Andrei, I am 17 years old, and I am part of the Programming and Mechanics department. I am passionate about mathematics and bicycles. I have 1 year of experience in FTC.",
    insta: "https://www.instagram.com/02andrei04/",
    gram: "@02andrei04",
  },
  {
    ...
    name: "David Georgescu (aka Struț)",
    role: "-> Mechanic & Driver",
    text: "Hi! My name is David, and I am a mechanic on the team, also part of the drive team. I have 1 year of experience in FTC and have been with my teammates since the team's founding!",
    insta: "https://www.instagram.com/david_st56/",
    gram: "@david_st56",
  },
  {
    ...
    name: "David Stroiuleasa",
    role: "-> Mechanic",
    text: "Passionate about robotics and drawn to the competitions of this science, I dedicate my time to designing and building competitive robots, dedicating time for achieving remarkable performance.",
    insta: "https://www.instagram.com/davidstroiuleasa/",
    gram: "@davidstroiuleasa",
  },
  {
    ...
    text: "Hello! My name is Iulia, I am 17 years old, and I am an 11th-grade student at 'Alexandru Odobescu' National College in Pitești. Within the team, I handle non-technical departments, and what I love most is working on graphic design.🌟",
    insta: "https://www.instagram.com/berevoianu_iulia/",
    gram: "@berevoianu_iulia",
  },
  {
    ...
    name: "Bucurel Lucian",
    role: "-> Design",
    text: "Socially, I am a cooperative person with well-developed theoretical and practical skills. A very good listener who always seeks solutions and aims to surpass himself.",
    insta: "https://www.instagram.com/lvcimf/",
    gram: "@lvcimf",
  },
  {
    ...
    name: "Maria Podea",
    role: "-> Peer Mentor",
    text: "Hello! I am Maria, 18 years old, and a student at UBB, FMI. After 2 years of FTC experience in both technical and non-technical departments, I am extremely excited to offer my support to the team as a Peer Mentor.",
    insta: "https://www.instagram.com/yasmina23maria/",
    gram: "@yasmina23maria",
  },
  {
    ...
    name: "Mihai Diaconu",
    role: "-> Peer Mentor",
    text: "I am Mihai Diaconu! I am one of the team's peer mentors. Previously, I worked in the programming department but had a slight inclination towards 3D modeling and assembly. For me, robotics represents an open door to new horizons.",
    insta: "https://www.instagram.com/adr0xd_/",
    gram: "@adr0xd_",
  },
  {
    ...
    name: "Mihai Stroiuleasa",
    role: "-> Mechanic",
    text: "Mihai is a mechanic on the team and is eager to learn as many new things as possible in this department.",
    insta: "",
    gram: "",
  },
  {
    ...
    name: "Popepescu Alexandru",
    role: "-> Mechanic & 3D Designer",
    text: "Hi! My name is Alexandru, I am 17 years old, and I handle the technical and 3D design department.",
    insta: "https://www.instagram.com/pope.alx/",
    gram: "@pope.alx",
  },
  {
    ...
    name: "Robert Raicu (aka Robby)",
    role: "-> Mechanic",
    text: "Hi! My name is Robert Raicu, I am 16 years old. Out of a desire to experience new things, I decided to join my high school’s robotics team, CNAO.",
    insta: "https://www.instagram.com/r0b._.3rt/",
    gram: "@r0b._.3rt",
  },
  {
    ...
    name: "Rebeca Vasile",
    role: "-> PR & Marketing",
    text: "Rebeca handles the non-technical department of the team and has been with us since the team's founding!",
    insta: "https://www.instagram.com/_rebeeca___/",
    gram: "@_rebeeca___",
  },
  {
    ...
    name: "Elena Sima (aka Tufă)",
    role: "-> PR & Design",
    text: "Hi! My name is Elena, I am 18 years old, and I am a 12th-grade student at 'Alexandru Odobescu' National College in Pitești. In the team, I mainly handle the design and PR departments.",
    insta: "https://www.instagram.com/tufaabb/",
    gram: "@tufaabb",
  },
  {
    ...
    name: "Borcaneci Sara",
    role: "-> Mechanic",
    text: "Sara is part of the technical department, striving to learn as many new things as possible in this field.",
    insta: "",
    gram: "",
  },
  {
    ...
    name: "Duminica Adriana",
    role: "-> PR & Design",
    text: "Hi! I am Adriana, 15 years old. I am a sociable person, and I love listening to music every moment of my life. I joined the robotics team because I am eager to enrich my knowledge and, besides that, I can do what I love.",
    insta: "https://www.instagram.com/adry.sunday/",
    gram: "@adry.sunday",
  },
  {
    ...
    name: "Andrei Florescu (aka Speedy)",
    role: "-> Mechanic",
    text: "My name is Andrei, and I am 18 years old. I am part of the Mechanics department. I joined the FTC program during the PowerPlay season. I strive to grow and learn new things.",
    insta: "https://www.instagram.com/_speedy05/",
    gram: "@_speedy05",
  },
  {
    ...
    name: "Nicolae Alexia",
    role: "-> PR & Design",
    text: "Alexia is part of the PR and Design department, and she joined the team with the desire to learn as many new things as possible.",
    insta: "",
    gram: "",
  },
  {
    ...
    name: "Ilie Evelyn (aka Eve)",
    role: "-> Human Player & PR",
    text: "Hi! I am Evelyn, 15 years old, and I am studying Natural Sciences. I saw robotics as an opportunity to improve my skills in various fields. For me, robotics is not just an activity but also a way to relax.",
    insta: "https://www.instagram.com/eve1ynn00/",
    gram: "@eve1ynn00",
  },
];
